...
"your day will be filled with luck", "it is time for a big change in your life", "do not procrastinate what can be accomplished in the present"]
...
/* this function will put together the random lucky number and fortune phrase */
const fortune = () => {
    const yourLuckyNum = capSentence(`your lucky number is ${luckyNum()}`);
    const yourFortune = capSentence(`${relCause}, ${pickMe(adviceArr)}`)
    return `${yourLuckyNum}. Today's fortune: ${yourFortune}.` 
};
